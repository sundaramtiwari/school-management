...
public class LateFeeAccrualIdempotencyTest extends BaseAuthenticatedIntegrationTest {
    ...
    void late_fee_should_be_idempotent() {
        ...
        StudentFeeAssignment assignment = assignmentRepository.findByStudentIdAndSessionId(studentId, sessionId).get(0);
        ...
        payReq.setAmountPaid(BigDecimal.valueOf(1000)); // Should pay the 500 late fee + 500 principal
        payReq.setMode("CASH");
        ...
        Assertions.assertThat(afterSecondPayment.getLateFeeAccrued()).isEqualByComparingTo(BigDecimal.valueOf(500));
    }
