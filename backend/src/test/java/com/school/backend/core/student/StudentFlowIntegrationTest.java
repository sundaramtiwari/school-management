...
public class StudentFlowIntegrationTest extends BaseAuthenticatedIntegrationTest {
    ...
    void student_register_enroll_promote_flow() {
        ...
        HttpEntity<StudentEnrollmentRequest> enrollEntity =
    ...
    void student_update_profile_flow() {
        ...
        studentId = createResp.getBody().getId();


        // ---------- Update Student ----------

        StudentUpdateRequest updateReq =
        ...
        HttpEntity<StudentUpdateRequest> updateEntity =
