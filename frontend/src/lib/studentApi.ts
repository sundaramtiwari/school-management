...
export const studentApi = {
    ...
    getPromotionHistory: (studentId: number) =>
        api.get(`/api/students/${studentId}/history/promotions`),
    ...
    withdraw: (studentId: number, body: { sessionId: number; withdrawalDate: string; reason?: string }) =>
